...
class SGD(Optimizer):
    ...
    def update(self, layer):
        for n, dv in layer.grads.items():
            ...
            #############################################################################
            layer.params[n] = layer.params[n] - dv * self.lr - self.weight_decay * layer.params[n]
            #############################################################################
            #                             END OF YOUR CODE                              #
            #############################################################################
    ...
    def update(self, layer):
        ...
        #############################################################################
         for n,v in layer.params.items():
            ...
            layer.params[n] -= self.lr * mt_hat/ (np.sqrt(vt_hat) + self.eps) - self.weight_decay * layer.params[n]
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
